      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-12 object-cover object-top rounded" src="../rose.jpeg" />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">Nursery</h2>
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Rose</h1>
              ...
              <div className="flex">
                <span className="title-font font-medium text-2xl text-gray-900">₹299</span>
                ...
                <button onClick={() => { addToCart(slug, 1, 499, 'Wear the code (XL/Black)', 'XL', 'red') }} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
              ...
              <div className="pin mt-6 flex space-x-3 text-sm">
                <input onChange={onChangePin} type="text" className='px-2 border-2 border-gray-400 rounded' placeholder='Enter Your Pin code' />
                <button onClick={checkServiceability} className='bg-pink-500 px-6 py-2 text-white border-0 focus:outline-none hover:bg-pinl-600 rounded'>Check {service} </button>
                {/* <p  >{ message}</p> */}
              </div>
