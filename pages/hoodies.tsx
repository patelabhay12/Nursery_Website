            ...
            <div className="lg:w-1/5 md:w-1/3 p-4 w-full cursor-pointer shadow-lg m-2 grid justify-center ">
              <Link href={'/product/wear-the-code'} >
                <div className="block relative rounded overflow-hidden">
                  <img alt="ecommerce" className="m-auto md:mx-0 h-[30vh] md:h-[36vh] block" src="./bonsai.jpeg" />
                </div>
                <div className="mt-4 text-center md:text-left">
                  <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">Plant</h3>
